      ...
      <div className="wrap">
        ...
        {/*<img src="image/back8.jpg" />*/}
          ...
          <div className="mainPart grid">
            <div className="tab_head act" onClick="fun1()"><p>В очереди</p></div>
            <div className="tab_head trans" onClick="fun2()"><p>Неназначеные</p></div>
            <div className="tab_main1 grid">
              ...
              <div className="news_head"><input type="text" placeholder="Заголовок новостей"/></div>
              <div className="news_tags"><input type="text" placeholder="#Теги"/></div>
              <div className="news_mainText">
                <textarea   cols="5" rows="5" wrap="soft"  placeholder="Описание"></textarea></div>
              <div className="news_settings">
                ...
                <p>Дата Создания:</p> <input type="datetime-local"/>
                <p>Дата Публикации:</p><input type="datetime-local"/>
                <p>Дата Удаления:</p><input type="datetime-local"/>

              </div>
              <div className="button"><p>Сохранить</p></div>
            </div>
            <div className="tab_main2 inactive">
